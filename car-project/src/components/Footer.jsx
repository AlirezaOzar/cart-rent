...
const Footer = () => {
    return ( 
        <div className="bg-white mt-20 mx-auto">
            <div className="border-b pb-10 flex flex-col items-center md:flex-row justify-center md:justify-around pt-10 px-3">
            ...
            <div className="border-t pt-4 flex flex-col-reverse md:flex-row justify-around gap-5 px-3 pb-10">
              <div className="font-semibold text-sm">©2022 MORENT. All rights reserved</div>
              <div className="font-semibold flex gap-4 text-sm justify-between">
                <p>Terms & Condition</p>
                <p>Privacy & Policy</p>
              </div>
            </div>
